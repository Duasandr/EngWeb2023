            ...
            <div class="w3-container">
                ...
                <table class="w3-table-all">
                    ...
                    <tr>
                        <!-- Submit task form -->
                        <td>
                            <form class="w3-container" method="POST" action="/submitTask">
                                <fieldset>
                                    <legend>Task</legend>
                            ...
                            <ul class="w3-ul w3-hoverable">
                                ${tasks.map(task => {
                                    ...
                                    if(task.completed == "false") 
                                        return `
                                    <li>
                                        <form method="POST" action="/submitDone">
...
exports.errorPage = function (code, error, date) {
    var pagHTML = `
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="w3-card-4">
            ...
            <div class="w3-container">
                ...
                <p>${error}</p>
                <p>Code: ${code}</p>
                <button class="w3-btn w3-purple w3-mb-2" onclick="window.location.href = '/'">Back</button>
            </div>
...
exports.taskPostConfirmPage = function (task, date) {
    var pagHTML = `
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="w3-card-4">
            ...
            <div class="w3-container">
                ...
                <p>Task submitted sucessfully!</p>
                <p>Task due date: ${task.dueDate}</p>
                <p>Task who: ${task.who}</p>
                <p>Task what: ${task.what}</p>
                <button class="w3-btn w3-purple w3-mb-2" onclick="window.location.href = '/'">Back</button>
            </div>
